...
class Metrics():
    ...
    def get_metrics(self, psnr, ssim, dice):
        self.psnrs.append(round(psnr, 2))
        self.ssims.append(round(ssim, 2))
        self.dices.append(round(dice, 2))
        # self.ious.append((iou, 2))
        self.psnrs_mean_var = str(round(np.mean(self.psnrs), 2)) + '+-' +  str(round(np.std(self.psnrs), 2))
        self.ssims_mean_var = str(round(100*np.mean(self.ssims), 2)) + '+-' +  str(round(100*np.std(self.ssims), 2))
