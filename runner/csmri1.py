...
from modeling.recon_net import CSMRIUnet
...
class ModelSet():
    def __init__(self, args, test=False):
        ...
        self.ckpt = './model_zoo/tab1/{}/csmri1_{}_{}.pth'.format(args.dataset_name, module, str(args.rate))
        args.save_path = self.ckpt
        self.model = CSMRIUnet(args.rate, args.mask, self.inputs_size).to(device, dtype=torch.float)
        ...
        print('batch={}, lr={}, dataset_name={}, load_model={}, save_per_epoch={}'\
            .format(self.batch, self.lr, args.dataset_name, args.load_model, 'best-model'))
        if test:
