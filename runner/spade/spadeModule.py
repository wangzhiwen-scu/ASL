...
sys.path.append('.') 
from runner.spade.blocks import *
...
class SemanticReconNet(nn.Module):
    def __init__(self, input_nc, output_nc, in_size=512, out_size=512, min_feat_size=15, ngf=64, n_blocks=9, parse_ch=19, relu_type='relu',
            ch_range=[32, 1024], norm_type='spade', n_class=3):
        super().__init__()
