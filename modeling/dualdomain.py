...
class MRIReconstruction(nn.Module):
    ...
    def forward(self, *input):
        ...
        k_to_img_1 = ifft(rec_k_1)  
        img_to_k_1 = fft(rec_img_1) 
        ...
        k_to_img_2 = ifft(rec_k_2)  
        img_to_k_2 = fft(rec_img_2) 
        ...
        k_to_img_3 = ifft(rec_k_3)  
        img_to_k_3 = fft(rec_img_3) 
        ...
        k_to_img_4 = ifft(rec_k_4)  
        img_to_k_4 = fft(rec_img_4) 
...
class DualDoRecNet(nn.Module):
    def __init__(self, desired_sparsity, w=0.2, bn=False):
    ...
    def forward(self, *input):
        ...
        rec_k_4 = self.dc41(k_fea_4, u_k, learned_mask) 
